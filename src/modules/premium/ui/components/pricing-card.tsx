...
export const PricingCard = ({variant, badge, price , features, title, description, priceSuffix, className, buttonText, onClick}:PricingCardProps)=>{
        ...
        <div className={cn(pricingCardVariants({variant}),className, "border")}>
            <div className="flex items-end gap-x-4 justify-between">
                ...
                <div className="flex items-end shrink-0 gap-x-0.5">
                      <h4 className="text-3xl fint-medium">
